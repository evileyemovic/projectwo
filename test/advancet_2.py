...
def train(args):
    ...
    with logger1:  # 두 Logger를 함께 관리
        ...
        # Get the paths
        csv_path, fig_path = logger1.csv_path, logger1.fig_path
    ...
    print('Model saved agent in', save_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--log_dir',
        type=str,
        default='experiments/Base2/',
    )
    parser.add_argument(
        '--log_dir1',
        type=str,
        default='experiments/Advance2_1/',
    )
    parser.add_argument(
        '--log_dir2',
        type=str,
        default='experiments/Advance2_2/',
    )
