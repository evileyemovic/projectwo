...
def traincs(args):
    ...
    for i in [0,1,2,3,4]:
        ...
        actext = input("액션 선택 : (폴드,0), (체크,콜,1), (하프벳,2), (팟벳,3),(올인,4) >>>")
        best_action, info = agent.eval_step(state)
        print(best_action)
        if int(actext) == int(best_action):
            print("놀랍습니다! 에이전트의 행동을 맞추셨습니다!")
            correct += 1
            print("정답 : %d개" % (correct))
            print("오답 : %d개" % (fail))
        else:
            ...
            if int(best_action) == 0:
                print("에이전트는 폴드를 권유합니다.")
                print("정답 : %d개" % (correct))
                print("오답 : %d개" % (fail))
            elif int(best_action) == 1:
                print("에이전트는 체크, 콜을을 권유합니다.")
                print("정답 : %d개" % (correct))
                print("오답 : %d개" % (fail))
            elif int(best_action) == 2:
                print("에이전트는 하프벳을 권장합니다.")
                print("정답 : %d개" % (correct))
                print("오답 : %d개" % (fail))
            elif int(best_action) == 3:
                print("에이전트는 강한 팟벳을 추천합니다.")
                print("정답 : %d개" % (correct))
                print("오답 : %d개" % (fail))
            else:
                print("에이전트는 올인을 강하게 추천합니다!!")
                print("정답 : %d개" % (correct))
                print("오답 : %d개" % (fail))
